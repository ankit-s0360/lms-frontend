        ...
        <HomeLayout>
            ...
            >
                ...
                >
                    ...
                    <div className="px-4 space-y-5 text-center-5">
                        ...
                        <button
                           type="submit"
                           className="bg-yellow-500 hover:bg-yellow-600 transition-all ease-in-out duration-300 absolute
                            bottom-0 rounded-bl-lg rounded-br-lg w-full left-0 py-2 text-xl font-bold"
                        >
                            Buy now
                        </button>
                    </div>
